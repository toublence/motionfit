...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get challengeTitle => 'تحدي القرفصاء الخاص بي';
  ...
  @override
  String get challengeDailyGoal => 'أهداف يومية للتكرارات';
  ...
  String challengeSevenDayPreview(int first, int last) {
    return 'اليوم 1: $first ← اليوم 7: $last تكرار';
  }
  ...
  @override
  String get challengePreset500 => '500 قرفصاء خلال 14 يومًا';
  ...
  String challengeRecommendationFromWorkout(int reps) {
    return 'موصى به بناءً على تمرينك الأول الذي بلغ $reps تكرارًا.';
  }
  ...
  String challengeTodayProgress(int current, int target) {
    return 'اليوم $current / $target تكرار';
  }
  ...
  String challengeTodaySuggested(int reps) {
    return 'الهدف المقترح لليوم: $reps تكرار';
  }
  ...
  @override
  String get challengeSquatStart => 'بدء القرفصاء';
  ...
  @override
  String get challengeGoalLabel => 'التكرارات المستهدفة';
  ...
  @override
  String get challengeTotalReps => 'إجمالي القرفصاء';
  ...
  @override
  String get challengeReminderNotificationTitle => 'تحدي القرفصاء بانتظارك';
  ...
  String get homeTodayNoWorkout =>
      'لم تؤدِّ تمارين القرفصاء اليوم بعد. ابدأ بمجموعة قصيرة.';

  @override
  String homeTodaySummary(int reps, int sets) {
    return '$reps قرفصاء ضمن $sets مجموعة';
  }
  ...
  @override
  String get homeRepsPerSetLabel => 'التكرارات لكل مجموعة';
  ...
  String get permissionCameraBody =>
      'يستخدم MotionFit الكاميرا لعدّ القرفصاء. لا يُحفظ الفيديو على هذا الجهاز إلا عند تفعيل المراجعة.';
  ...
  @override
  String get calibrationTitle => 'جارٍ تحديد وضع الوقوف';

  @override
  String get calibrationBody => 'قف باستقامة واجعل جسمك كاملًا ظاهرًا.';
  ...
  @override
  String get workoutStateDescending => 'نزول';

  @override
  String get workoutStateBottom => 'في أدنى وضع';

  @override
  String get workoutStateAscending => 'صعود';

  @override
  String get workoutStateCompleted => 'تكرار رائع';
  ...
  @override
  String get restTotalReps => 'القرفصاء حتى الآن';
  ...
  @override
  String get completeTotalReps => 'إجمالي القرفصاء';
  ...
  @override
  String get completeAverageRepTime => 'متوسط زمن التكرار';
  ...
  String coachingIssueFrequency(int total, int count, String issue) {
    return 'في $count من أصل $total تكرارات:\n$issue';
  }
  ...
  String recordsMoreThanLastWeek(int count) {
    return 'أديت $count تكرارات أكثر من الأسبوع الماضي';
  }

  @override
  String recordsLessThanLastWeek(int count) {
    return 'أديت $count تكرارات أقل من الأسبوع الماضي';
  }
  ...
  @override
  String get recordsEmptyBody => 'أكمل أول تمرين قرفصاء وسيظهر هنا.';
  ...
  @override
  String get statsTotalReps => 'إجمالي القرفصاء';
  ...
  @override
  String get statsAverageReps => 'متوسط القرفصاء';

  @override
  String get statsDailyReps => 'القرفصاء حسب اليوم';
  ...
  @override
  String get detailSetBreakdown => 'التكرارات حسب المجموعة';

  @override
  String get detailTotalReps => 'إجمالي القرفصاء';

  @override
  String get detailAverageRep => 'متوسط زمن التكرار';
  ...
  String detailSetRow(int set, int reps) {
    return 'المجموعة $set: $reps تكرار';
  }
  ...
  @override
  String get voiceRepCountEnabled => 'نطق عدد التكرارات';
  ...
  String get appInfoDescription =>
      'يعدّ MotionFit تمارين القرفصاء ويقدم إرشادات خاصة على الجهاز لتحسين الأداء.';
  ...
  @override
  String get formIssueDepth => 'عمق القرفصاء';

  @override
  String get formIssueTorsoLean => 'ثبات الجزء العلوي';

  @override
  String get formIssueHeelLift => 'ثبات الكعبين';

  @override
  String get formIssueKneeAlignment => 'محاذاة الركبتين';
  ...
  @override
  String get formIssueControl => 'التحكم في الحركة';
  ...
  @override
  String get coachWholeBody1 => 'ارجع خطوة حتى يظهر جسمك كاملًا.';

  @override
  String get coachWholeBody2 => 'تأكد من ظهورك من الرأس إلى القدمين.';
  ...
  @override
  String get coachReady2 => 'موضع رائع. استعد لأول قرفصاء.';
  ...
  String coachCumulativeChallengeStart(int completed, int remaining) {
    return 'يبدأ تحدي التكرارات التراكمية. أكملت $completed تكرارًا، وتبقى $remaining تكرارًا.';
  }
  ...
  @override
  String get coachDepth1 => 'في التكرار التالي، حاول النزول أكثر قليلًا.';

  @override
  String get coachDepth2 => 'أضف قليلًا من العمق إلى القرفصاء التالية.';

  @override
  String get coachTorso1 => 'حافظ على ثبات الجزء العلوي أكثر قليلًا.';

  @override
  String get coachTorso2 => 'في التكرار التالي، أبقِ صدرك مرفوعًا بشكل مريح.';

  @override
  String get coachHeel1 => 'حاول إبقاء كعبيك على الأرض.';

  @override
  String get coachHeel2 => 'اضغط بقدمك كاملة على الأرض في التكرار التالي.';

  @override
  String get coachKnees1 => 'وجّه ركبتيك في اتجاه أصابع قدميك.';

  @override
  String get coachKnees2 => 'في التكرار التالي، حافظ على محاذاة ركبتيك بهدوء.';

  @override
  String get coachBalance1 => 'وزّع وزنك بالتساوي على الجانبين.';
  ...
  @override
  String get coachAscendControlled1 => 'اصعد بسلاسة وحافظ على التحكم.';

  @override
  String get coachAscendControlled2 => 'حافظ على وتيرة ثابتة أثناء الوقوف.';

  @override
  String get coachAscendFaster1 => 'اصعد بقوة أكبر قليلًا.';

  @override
  String get coachAscendFaster2 => 'في التكرار التالي، قف بوتيرة أسرع قليلًا.';
  ...
  @override
  String get coachStandTall1 => 'أنه الحركة بالوقوف باستقامة أكثر قليلًا.';

  @override
  String get coachStandTall2 => 'عُد بالكامل إلى وضع الوقوف.';

  @override
  String get coachGood1 => 'رائع. حافظ على هذا الإيقاع.';

  @override
  String get coachGood2 => 'تحكم جيد. واصل هكذا.';

  @override
  String get coachGood3 => 'تكرار قوي. كرره مرة أخرى.';
  ...
  String coachWorkoutComplete(int reps) {
    return 'اكتمل التمرين. أنهيت $reps حركة قرفصاء.';
  }
  ...
  String semanticsCurrentRep(int current, int target) {
    return 'التكرار الحالي $current من $target';
  }
  ...
  @override
  String get viewRepTimeline => 'عرض مخطط التكرارات';

  @override
  String get repTimelineTitle => 'مراجعة التكرارات';
  ...
  @override
  String get repTimelineNoImprovement => 'لا توجد تكرارات تحتاج إلى تحسين.';
  ...
  @override
  String get repResultImproved => 'أفضل من التكرار السابق';

  @override
  String get repResultNotAssessed => 'يصعب التقييم';

  @override
  String get repIssueShallowDepth => 'حاول النزول بعمق أكبر قليلًا';

  @override
  String get repIssueForwardLean => 'مال الجزء العلوي إلى الأمام';
  ...
  @override
  String get repPrevious => 'التكرار السابق';
  ...
  String get repFeedbackDepth =>
      'لم تصل إلى عمق القرفصاء المعتاد. انخفض قليلًا أكثر مع إبقاء الصدر ثابتًا.';

  @override
  String get repFeedbackTorso =>
      'مال الجزء العلوي من جسمك كثيرًا إلى الأمام. أبقِ صدرك أكثر استقامة.';
  ...
  String repFeedbackGeneric(String area) {
    return 'يحتاج هذا التكرار إلى الانتباه في $area.';
  }
