...
import 'package:motionfit_squat/features/challenges/domain/challenge.dart';
          ...
          if (recommended) ...[
            Row(
              children: [
                ...
                Text(
                  AppLocalizations.of(context).challengeRecommended,
    ...
    return Column(
      ...
      children: [
        ...
        Align(
          alignment: AlignmentDirectional.centerStart,
          child: TextButton(
            onPressed: () => context.push('/challenge/${challenge.id}'),
...
Future<void> startChallengeWorkout(
  ...
  final savedPlan = ref.read(preferencesControllerProvider).lastWorkoutPlan;
...
String challengeName(AppLocalizations l10n, ChallengeType type) =>
    switch (type) {
...
String challengeStatusName(AppLocalizations l10n, ChallengeStatus status) =>
    switch (status) {
