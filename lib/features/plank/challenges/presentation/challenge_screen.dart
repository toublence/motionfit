        ...
        children: [
          if (recommended) ...[
            Row(
              children: [
                ...
                Text(
                  PlankLocalizations.of(context).challengeRecommended,
                ...
                const Spacer(),
                IconButton(
                  tooltip: PlankLocalizations.of(context).commonClose,
          ...
          Align(
            ...
            child: TextButton(
              ...
              child: Text(
                compact
                    ? PlankLocalizations.of(context).commonStart
                    : buttonLabel,
              ),
            ),
          ),
    ...
    return Column(
      ...
      children: [
        ...
        Align(
          alignment: AlignmentDirectional.centerStart,
          child: TextButton(
            onPressed: () => context.push('/challenge/plank/${challenge.id}'),
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Column(
      children: [
        ListTile(
          contentPadding: EdgeInsets.zero,
          onTap: () => context.push('/challenge/plank/${challenge.id}'),
...
String challengeName(PlankLocalizations l10n, ChallengeType type) =>
    switch (type) {
...
String challengeStatusName(PlankLocalizations l10n, ChallengeStatus status) =>
    switch (status) {
