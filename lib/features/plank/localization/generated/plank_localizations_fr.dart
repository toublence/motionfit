...
class PlankLocalizationsFr extends PlankLocalizations {
  PlankLocalizationsFr([String locale = 'fr']) : super(locale);

  @override
  String get appName => 'MotionFit - Gainage';

  @override
  String get navSquat => 'Gainage';
  ...
  String challengeSevenDayPreview(int first, int last) {
    return 'Jour 1 : $first → Jour 7 : $last secondes';
  }
  ...
  @override
  String get challengePreset500 => '500 secondes de gainage en 14 jours';
  ...
  String challengeRecommendationFromWorkout(int reps) {
    return 'Recommandé d’après votre premier entraînement de $reps secondes.';
  }
  ...
  String challengeTodayProgress(int current, int target) {
    return 'Aujourd’hui $current / $target secondes';
  }
  ...
  String challengeRepsProgress(int current, int target) {
    return '$current / $target secondes';
  }
  ...
  String challengeTodaySuggested(int reps) {
    return 'Objectif conseillé aujourd’hui : $reps secondes';
  }
  ...
  @override
  String get challengeSquatStart => 'Commencer le gainage';
  ...
  @override
  String get challengeGoalLabel => 'secondes cibles';
  ...
  @override
  String get challengeTotalReps => 'Total de secondes de gainage';
  ...
  String homeTodaySummary(int reps, int sets) {
    return 'secondes de gainage : $reps · Séries : $sets';
  }
  ...
  @override
  String get homeRepsPerSetLabel => 'Secondes par série';
  ...
  @override
  String get workoutStateCompleted => 'Une seconde tenue';
  ...
  @override
  String get restTotalReps => 'secondes de gainage jusqu’ici';
  ...
  @override
  String get completeAverageRepTime => 'Temps moyen par seconde';
  ...
  String coachingIssueFrequency(int total, int count, String issue) {
    return 'Sur $total secondes, $count montrent :\n$issue';
  }
  ...
  String recordsMoreThanLastWeek(int count) {
    return '$count secondes de plus que la semaine dernière';
  }

  @override
  String recordsLessThanLastWeek(int count) {
    return '$count secondes de moins que la semaine dernière';
  }
  ...
  @override
  String get statsTotalReps => 'Total de secondes de gainage';
  ...
  @override
  String get statsAverageReps => 'Moyenne de secondes de gainage';

  @override
  String get statsDailyReps => 'secondes de gainage par jour';
  ...
  @override
  String get detailSetBreakdown => 'secondes par série';

  @override
  String get detailTotalReps => 'Total de secondes de gainage';

  @override
  String get detailAverageRep => 'Temps moyen par seconde';
  ...
  @override
  String get voiceRepCountEnabled => 'Annoncer les secondes';
  ...
  String coachCumulativeChallengeStart(int completed, int remaining) {
    return 'Le défi de secondes cumulées commence. Tu as réalisé $completed secondes, il en reste $remaining.';
  }
  ...
  @override
  String get coachDepth1 => 'Aligne les hanches avec les épaules.';

  @override
  String get coachDepth2 => 'Aligne les hanches avec les épaules.';

  @override
  String get coachTorso1 => 'Gaine le centre du corps et garde le dos droit.';
  ...
  @override
  String get coachAscendControlled2 => 'Aligne les hanches avec les épaules.';

  @override
  String get coachAscendFaster1 => 'Aligne les hanches avec les épaules.';

  @override
  String get coachAscendFaster2 => 'Aligne les hanches avec les épaules.';

  @override
  String get coachControl1 => 'Gaine le centre du corps et garde le dos droit.';
  ...
  String coachWorkoutComplete(int reps) {
    return 'Entraînement terminé. Tu as tenu $reps secondes de gainage.';
  }
  ...
  String semanticsCurrentRep(int current, int target) {
    return 'seconde actuelle : $current sur $target';
  }
  ...
  @override
  String get viewRepTimeline => 'Voir les secondes';

  @override
  String get repTimelineTitle => 'Analyse des secondes';
  ...
  @override
  String get repTimelineNoImprovement => 'Aucune seconde n’est à améliorer.';
  ...
  @override
  String get repPrevious => 'seconde précédente';
  ...
  String repFeedbackGeneric(String area) {
    return 'Cette seconde demande de l’attention pour $area.';
  }
