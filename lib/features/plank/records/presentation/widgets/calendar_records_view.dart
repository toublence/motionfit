...
import 'package:motionfit_squat/features/plank/records/presentation/widgets/monthly_workout_calendar.dart';
...
String? _aggregateStrength(PlankLocalizations l10n, List<RepRecord> reps) {
  ...
  Widget build(BuildContext context) {
    ...
    return DecoratedBox(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () => context.push('/records/plank/session/${session.id}'),
          child: Padding(
                  ...
                  children: [
                    Expanded(
                      child: FittedBox(
                        ...
                        alignment: AlignmentDirectional.centerStart,
                        child: Text(
                          '${l10n.unitSeconds(session.totalReps)}  ·  '
...
String _compactDuration(PlankLocalizations l10n, int seconds) =>
