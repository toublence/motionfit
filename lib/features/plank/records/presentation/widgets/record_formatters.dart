...
String formatRecordDuration(PlankLocalizations l10n, int totalSeconds) {
...
String formatAverageRepDuration(PlankLocalizations l10n, int milliseconds) {
...
String formIssueLabel(PlankLocalizations l10n, FormIssue issue) =>
    switch (issue) {
