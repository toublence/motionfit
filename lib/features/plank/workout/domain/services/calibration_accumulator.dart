...
class CalibrationAccumulator {
  ...
  final List<SquatMetrics> _samples = [];
  int? _startedAtUs;
  ...
  CalibrationProfile? add(SquatMetrics metrics) {
    ...
    final plankLike =
        ...
        metrics.hipAngle >= 150 &&
        metrics.torsoLeanDegrees >= 45 &&
        metrics.torsoLeanDegrees <= 135;
    if (!plankLike || metrics.confidence < config.aggregateConfidenceFloor) {
      _restart();
      return null;
    }
