...
String repResultLabel(PlankLocalizations l10n, RepAnalysis analysis) =>
...
String repIssueLabel(PlankLocalizations l10n, FormIssue? issue) =>
    switch (issue) {
...
String repIssueCategory(PlankLocalizations l10n, FormIssue? issue) =>
    switch (issue) {
...
String repFeedback(PlankLocalizations l10n, RepAnalysis analysis) {
