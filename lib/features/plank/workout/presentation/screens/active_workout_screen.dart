...
import 'package:motionfit_squat/features/plank/workout/presentation/widgets/pose_overlay.dart';
...
class _ActiveWorkoutScreenState extends ConsumerState<ActiveWorkoutScreen>
  ...
  Future<void> _syncCameraLifecycle() async {
    ...
    final backgroundPauseReason = PlankLocalizations.of(
      context,
  ...
  void _navigateForStatus(WorkoutSessionState next) {
    ...
    final location = switch (next.status) {
      WorkoutSessionStatus.resting => '/plank/workout/rest',
      WorkoutSessionStatus.completed ||
      WorkoutSessionStatus.interrupted => '/plank/workout/summary',
      _ => null,
    };
    if (location == null) return;
    _navigating = true;
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      if (location == '/plank/workout/summary') {
