...
import 'package:motionfit_squat/features/plank/workout/domain/services/rep_clip.dart';
...
class _RepReviewContentState extends ConsumerState<_RepReviewContent> {
  ...
  void _open(RepAnalysis analysis) {
    context.pushReplacement(
      '/plank/hold-timeline/${widget.sessionId}/second/${analysis.repNumber}',
    );
  }
  ...
  List<String> _strengths(PlankLocalizations l10n, RepAnalysis analysis) => [
