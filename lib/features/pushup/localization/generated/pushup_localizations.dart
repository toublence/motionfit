...
import 'pushup_localizations_ar.dart';
import 'pushup_localizations_de.dart';
import 'pushup_localizations_en.dart';
import 'pushup_localizations_es.dart';
import 'pushup_localizations_fr.dart';
import 'pushup_localizations_ja.dart';
import 'pushup_localizations_ko.dart';
import 'pushup_localizations_zh.dart';

// ignore_for_file: type=lint

/// Callers can lookup localized strings with an instance of PushupLocalizations
/// returned by `PushupLocalizations.of(context)`.
///
/// Applications need to include `PushupLocalizations.delegate()` in their app's
/// `localizationDelegates` list, and the locales they support in the app's
/// `supportedLocales` list. For example:
///
/// ```dart
/// import 'generated/pushup_localizations.dart';
///
/// return MaterialApp(
///   localizationsDelegates: PushupLocalizations.localizationsDelegates,
///   supportedLocales: PushupLocalizations.supportedLocales,
...
abstract class PushupLocalizations {
  ...
  static PushupLocalizations of(BuildContext context) {
  ...
  ///
  /// In en, this message translates to:
  /// **'Day 1: {first} reps → Day 7: {last} reps'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Reach a total pushup target on a schedule that works for you'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Recommended from your first workout of {reps} reps.'**
  ...
  /// No description provided for @challengePushupStart.
  ///
  /// In en, this message translates to:
  /// **'Start pushups'**
  String get challengePushupStart;
  ...
  ///
  /// In en, this message translates to:
  /// **'Your pushup challenge is waiting'**
  ...
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =0 {0 reps} =1 {1 rep} other {{count} reps}}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'No pushups yet today. A short set is a great start.'**
  String get homeTodayNoWorkout;

  /// No description provided for @homeTodaySummary.
  ///
  /// In en, this message translates to:
  /// **'{reps} pushups across {sets}'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Set the phone side-on so your hands, shoulders, hips, and feet stay in view.'**
  String get guideSubtitle;

  /// No description provided for @guideLandscape.
  ///
  /// In en, this message translates to:
  /// **'Turn your phone sideways (landscape) and place it beside you.'**
  String get guideLandscape;

  /// No description provided for @guideWholeBody.
  ///
  /// In en, this message translates to:
  /// **'Keep one complete arm and your body line visible.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'MotionFit uses the camera to count pushups. Video is saved only on this device when you turn on Rep Video Review.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Finding your top push-up position'**
  String get calibrationTitle;

  /// No description provided for @calibrationBody.
  ///
  /// In en, this message translates to:
  /// **'Hold the top push-up position with your arms extended.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'We could not get a clear top push-up position.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Complete your first pushup workout and it will appear here.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'MotionFit counts pushups and offers private, on-device form guidance.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Keep one wrist, elbow, shoulder, hip, and ankle in view.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Keep your wrist, elbow, shoulder, hip, and ankle in view.'**
  String get coachWholeBody1;

  /// No description provided for @coachWholeBody2.
  ///
  /// In en, this message translates to:
  /// **'Move the phone farther away so your full push-up position is visible.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Great position. Get ready for your first pushup.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Starting the cumulative reps challenge. You have completed {completed} reps, with {remaining} remaining.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Next rep, try going a little lower.'**
  String get coachDepth1;

  /// No description provided for @coachDepth2.
  ///
  /// In en, this message translates to:
  /// **'Give the next pushup a little more depth.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Control the way down on your next rep.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'A few focused pushups can make today’s movement count.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'You did not reach your usual pushup depth. Try lowering a little more while keeping your chest stable.'**
  String get repFeedbackDepth;

  /// No description provided for @repFeedbackTorso.
  ///
  /// In en, this message translates to:
  /// **'Your body line changed during this rep. Brace your core and keep your hips level.'**
  String get repFeedbackTorso;

  /// No description provided for @repFeedbackKnees.
  ///
  /// In en, this message translates to:
  /// **'Your elbows flared outward. Keep them angled back toward your body.'**
  String get repFeedbackKnees;

  /// No description provided for @repFeedbackGeneric.
  ///
  /// In en, this message translates to:
  /// **'This rep needs attention in {area}.'**
...
class _PushupLocalizationsDelegate
  ...
  @override
  Future<PushupLocalizations> load(Locale locale) {
    return SynchronousFuture<PushupLocalizations>(lookupPushupLocalizations(locale));
  }
