...
class PushupLocalizationsFr extends PushupLocalizations {
  ...
  @override
  String get challengeSevenDaySettingsDescription => 'Choisissez le jour 1. L’objectif augmente de 5 répétitions par jour.';
  ...
  @override
  String get challengeCumulativeDescription => 'Atteignez un total de pompes selon votre emploi du temps';
  ...
  @override
  String get challengeReminderNotificationTitle => 'Votre défi de pompes vous attend';
  ...
  @override
  String get homeTodayNoWorkout => 'Pas encore de pompes aujourd’hui. Une petite série est un excellent début.';
  ...
  @override
  String get guideSubtitle => 'Place le téléphone de côté pour garder mains, épaules, hanches et pieds visibles.';

  @override
  String get guideLandscape => 'Tourne le téléphone en mode paysage et place-le à côté de toi.';

  @override
  String get guideWholeBody => 'Garde un bras complet et la ligne du corps visibles.';
  ...
  @override
  String get guidePrivacy => 'La vidéo reste sur cet appareil et n’est enregistrée que si la revue par répétition est activée.';
  ...
  @override
  String get permissionCameraBody => 'MotionFit utilise la caméra pour compter les pompes. La vidéo n’est enregistrée sur cet appareil que si la revue est activée.';
  ...
  @override
  String get calibrationBody => 'Tiens la position haute de pompe, bras tendus.';
  ...
  @override
  String get calibrationFailed => 'Ta position haute de pompe n’a pas pu être détectée clairement.';
  ...
  @override
  String get recordsEmptyBody => 'Termine ton premier entraînement de pompes pour le retrouver ici.';
  ...
  @override
  String get privacyStoredDataDescription => 'MotionFit enregistre les heures d’entraînement, les séries, les répétitions et les résultats techniques pour te permettre de suivre tes progrès.';
  ...
  @override
  String get appInfoDescription => 'MotionFit compte les pompes et fournit des conseils techniques privés, directement sur ton appareil.';
  ...
  @override
  String get coachWholeBody1 => 'Garde poignet, coude, épaule, hanche et cheville dans le cadre.';

  @override
  String get coachWholeBody2 => 'Éloigne-toi pour montrer toute la position de pompe.';
  ...
  @override
  String get coachReady2 => 'Bonne position. Prépare-toi pour ton premier pompe.';
  ...
  @override
  String get coachDepth1 => 'À la prochaine répétition, essaie de descendre un peu plus bas.';

  @override
  String get coachDepth2 => 'Donne un peu plus de profondeur au prochain pompe.';
  ...
  @override
  String get coachKnees1 => 'Oriente les coudes vers l’arrière, pas sur les côtés.';
  ...
  @override
  String get coachBalance2 => 'Trouve une position stable et équilibrée pour la prochaine répétition.';

  @override
  String get coachDescendSlow1 => 'La prochaine fois, essaie de descendre un peu plus lentement.';

  @override
  String get coachDescendSlow2 => 'Maîtrise la descente à la prochaine répétition.';

  @override
  String get coachDescendFaster1 => 'À la prochaine répétition, descends un peu plus rapidement.';

  @override
  String get coachDescendFaster2 => 'Lors de la prochaine descente, continue le mouvement sans marquer de pause.';

  @override
  String get coachAscendControlled1 => 'Remonte en douceur et garde le contrôle.';

  @override
  String get coachAscendControlled2 => 'Repousse à un rythme régulier et contrôlé.';

  @override
  String get coachAscendFaster1 => 'Remonte avec un peu plus d’élan.';

  @override
  String get coachAscendFaster2 => 'À la prochaine répétition, repousse un peu plus franchement.';

  @override
  String get coachControl1 => 'Réalise la prochaine répétition avec fluidité du début à la fin.';
  ...
  @override
  String get notificationReminderBodyVariant2 => 'Quelques pompes bien exécutés suffisent pour faire bouger ta journée.';
  ...
  @override
  String get repVideoReviewDescription => 'Enregistrez la vidéo de cette séance sur l’appareil pour revoir chaque répétition ensuite.';
  ...
  @override
  String get repFeedbackGood => 'Cette répétition est restée dans les plages que MotionFit a pu évaluer.';

  @override
  String get repFeedbackDepth => 'Vous n’avez pas atteint votre profondeur habituelle. Descendez un peu plus en gardant le buste stable.';

  @override
  String get repFeedbackTorso => 'La ligne du corps a changé. Gaine le tronc et stabilise les hanches.';

  @override
  String get repFeedbackKnees => 'Tes coudes se sont écartés. Oriente-les vers l’arrière près du corps.';
