...
String repResultLabel(PushupLocalizations l10n, RepAnalysis analysis) =>
...
String repIssueLabel(PushupLocalizations l10n, FormIssue? issue) =>
    switch (issue) {
...
String repIssueCategory(PushupLocalizations l10n, FormIssue? issue) =>
    switch (issue) {
...
String repFeedback(PushupLocalizations l10n, RepAnalysis analysis) {
