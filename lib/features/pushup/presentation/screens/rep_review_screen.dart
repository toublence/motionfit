...
import 'package:motionfit_squat/features/pushup/domain/services/rep_clip.dart';
...
class _RepReviewContentState extends ConsumerState<_RepReviewContent> {
  ...
  void _open(RepAnalysis analysis) {
    context.pushReplacement(
      '/pushup/rep-timeline/${widget.sessionId}/rep/${analysis.repNumber}',
    );
  }
  ...
  List<String> _strengths(PushupLocalizations l10n, RepAnalysis analysis) => [
