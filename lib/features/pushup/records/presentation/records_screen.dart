...
import 'package:motionfit_squat/features/pushup/records/presentation/widgets/calendar_records_view.dart';
...
class _RecordsScreenState extends ConsumerState<RecordsScreen> {
  ...
  Future<void> _startWorkout() async {
    ...
    final plan = ref.read(preferencesControllerProvider).pushupLastWorkoutPlan;
