...
String? _aggregateStrength(PushupLocalizations l10n, List<RepRecord> reps) {
  ...
  Widget build(BuildContext context) {
    ...
    return DecoratedBox(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () => context.push('/records/pushup/session/${session.id}'),
          child: Padding(
                  ...
                  children: [
                    Expanded(
                      child: FittedBox(
                        ...
                        alignment: AlignmentDirectional.centerStart,
                        child: Text(
                          '${session.totalReps} ${l10n.navPushup}  ·  '
...
String _compactDuration(PushupLocalizations l10n, int seconds) =>
