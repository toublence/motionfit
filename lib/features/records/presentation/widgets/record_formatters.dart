...
String formatRecordDuration(AppLocalizations l10n, int totalSeconds) {
...
String formatAverageRepDuration(AppLocalizations l10n, int milliseconds) {
...
String formIssueLabel(AppLocalizations l10n, FormIssue issue) =>
    switch (issue) {
