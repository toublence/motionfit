...
import 'package:motionfit_squat/features/squat/presentation/widgets/pose_overlay.dart';
...
class _ActiveWorkoutScreenState extends ConsumerState<ActiveWorkoutScreen>
  ...
  Future<void> _syncCameraLifecycle() async {
    ...
    final backgroundPauseReason = AppLocalizations.of(
      context,
  ...
  void _navigateForStatus(WorkoutSessionState next) {
    ...
    final location = switch (next.status) {
      WorkoutSessionStatus.resting => '/workout/rest',
      WorkoutSessionStatus.completed ||
      WorkoutSessionStatus.interrupted => '/workout/summary',
      _ => null,
    };
