...
class SquatHomeScreen extends ConsumerStatefulWidget {
  const SquatHomeScreen({super.key});

  @override
  ConsumerState<SquatHomeScreen> createState() => _SquatHomeScreenState();
}
...
class _SquatHomeScreenState extends ConsumerState<SquatHomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final plan = preferences.lastWorkoutPlan;
          ...
          children: [
            ...
            if (latest != null)
              TextButton.icon(
                ...
                onPressed: () =>
                    context.push('/records/session/${latest.session.id}'),
